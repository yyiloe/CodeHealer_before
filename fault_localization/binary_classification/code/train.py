...
if __name__ == "__main__":
    ...
    model = BinaryClassifier(pretrain_vectors, EMBEDDING_DIM, MAX_TOKENS, 400, 0.1, 1, 2, HEAD_NUMS)
    ...
    # optimizer = torch.optim.SGD(parameters, lr=0.0005)
    ...
    with open(
            "/home/dancher/Programs/Projects/trans2/TRANSFER-master/fault_localization/binary_classification/code/result.txt",
            'a') as result:
        result.write(fix_pattern + " " + str(total_acc / total) + "\n")
